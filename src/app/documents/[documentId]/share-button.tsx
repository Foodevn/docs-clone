...
export default function ShareButton() {
    ...
    if (permission.role != "admin" && permission.role !== "member") {
        return (
            <div className="flex items-center gap-2 bg-blue-100 text-slate-800 font-medium px-4 py-2 rounded-full transition-all duration-150 border border-transparent">
    ...
    if (permission.role != "admin") {
        return (
            <div className="flex items-center gap-2 bg-blue-100 hover:bg-blue-200 text-slate-800 font-medium px-4 py-2 rounded-full transition-all duration-150 border border-transparent">
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50 border-b">
                            <tr className="text-left text-gray-500">
                                ...
                                {permission.role.trim().toLowerCase() === "admin" && (
                            ...
                            {members &&
                                members.map((m) => (
                                    ...
                                    >
                                        ...
                                        {/* Actions */}
                                        {permission.role.trim().toLowerCase() === "admin" &&
                                            m.permission.trim().toLowerCase() !== "admin" && (
